...
<head>
  ...
  <style>
    ...
    .sidebar-scroll::-webkit-scrollbar-track { background: #f1f5f9; border-radius: 2px; }
          ...
          <?php foreach (array_slice($popularGames, 0, 6) as $popular): ?>
            ...
            <div class="flex items-start space-x-3 group">
              ...
              <div class="flex-1 min-w-0">
                <a href="detail.php?id=<?= $popular['id'] ?>" class="block group-hover:text-blue-600 transition-colors duration-200">
